...
xGarage = {
    ...
    RageUI = {
        ...
        FontText = 6, -- Police d'écriture (Titre principal)
        ...
        ["1"] = {Pagination = 1},-- Nombre d'éléments (minimum)
        ["2"] = {Pagination = 20},-- Nombre d'éléments (maximum)

        ["3"] = {Width = 431}, -- Largeur de la fenêtre
        ["4"] = {Height = 107}, -- Hauteur de la fenêtre

        ["5"] = {X = 0.5}, -- Position X de la fenêtre
        ["6"] = {Y = 0.5}, -- Position Y de la fenêtre
